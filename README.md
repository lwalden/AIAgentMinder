...
Repo template that provides a pre-configured framework for Claude Code to work autonomously on your projects with session continuity, architectural decision tracking, and comprehensive permissions. 

Move from your project from the planning to the doing phase in minutes.
...
2. **Customize the templates:**
   ...
   - `CLAUDE.md` - Adjust developer profile and tech stack sections
   - `PROGRESS.md` - Update initial tasks for your project (100% optional)
   - `DECISIONS.md` - Pre-populate with any known decisions (100% optional)

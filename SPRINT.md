...
|---|---|---|---|---|---|
| S9-001 | Spike: reproduce F1–F6 deterministically [risk] | spike | ⚠ | in-progress | n/a |
| S9-002 | F1 — SessionStart clears stale `.context-usage` | fix | | todo | n/a |
| S9-003 | F2 — status-line warmup hysteresis | fix | | todo | n/a |

...
export const MIGRATIONS = [
  ...
  {
    version: '5.0.0',
    description: 'Orchestrator + instrumentation — add sprint-master, phase agents, metrics script',
    delete: [
      // sprint-executor.md is NOT deleted — it remains valid for standalone use
      // without the orchestrator. Users can choose sprint-executor OR sprint-master.
    ],
    rename: [],

...
export const MIGRATIONS = [
  ...
  },
  {
    ...
    rename: [
      ...
      // aam-checkup removed in v4.2 — sync --dry-run replaces its function
  ...
  {
    version: '4.6.0',
    description: 'Retire AAM correction-capture — Claude Code native Auto Memory supersedes it',
    delete: [
  ...
  {
    version: '5.0.0',
    description: 'Orchestrator + instrumentation — add sprint-master, phase agents, metrics script; remove sprint-executor',
    delete: [
      // sprint-executor is removed — sprint-master (orchestrator) is the sprint agent.
      '.claude/agents/sprint-executor.md',
    ],
    rename: [],
    // New files (sprint-master, sprint-planner, sprint-speccer, item-executor,
    // quality-reviewer, pr-pipeliner, sprint-retro, sprint-metrics.sh) are
    // additions handled by sync.js filesystem walk — no explicit action needed.
  },
];

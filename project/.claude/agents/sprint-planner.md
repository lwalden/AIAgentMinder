...
3. Check BACKLOG.md for items tagged for this phase or marked high-priority.
4. Check `SPRINT.md` archives for sizing hints. Default 4-5 items, max 7.
5. Decompose into 4-7 issues covering a coherent subset.

---
name: aam-checkup
description: Installation health check — validate that AIAgentMinder is correctly installed and configured. Checks Node.js, required files, hook script and config, CLAUDE.md placeholders, version stamp, and git status. Outputs a PASS/WARN/FAIL report with remediation steps.
user-invocable: true

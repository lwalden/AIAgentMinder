---
name: aam-grill
description: Intensive plan interrogation — systematically question every aspect of a proposed design or architecture change until all branches of the decision tree are resolved. Produces a decision summary for DECISIONS.md. The thorough alternative to approach-first's quick check-in.
argument-hint: "[describe the plan, design, or architecture change to interrogate]"
user-invocable: true

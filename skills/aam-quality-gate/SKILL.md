...
description: Run pre-PR quality checks. Always runs the full Comprehensive checklist. Called automatically before PR creation in the sprint workflow; also invocable manually before any pull request.
user-invocable: true

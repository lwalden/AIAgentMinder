---
name: aam-revise
description: Revise the project plan — add, change, drop, or reprioritize features in docs/strategy-roadmap.md. Synthesizes research findings and requirement changes directly into planning documents with decision logging and sprint impact checks.
argument-hint: "[describe what changed, or provide a path to research findings]"
user-invocable: true

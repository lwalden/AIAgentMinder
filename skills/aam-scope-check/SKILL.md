---
name: aam-scope-check
description: Active scope governance — evaluate a proposed feature, task, or change against the project roadmap before building it. Returns a verdict (in scope / out of scope / deferred / not in roadmap) with a clear path to proceed.
argument-hint: "[describe the feature or task you're considering]"
user-invocable: true

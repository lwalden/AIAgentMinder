---
name: aam-sync-issues
description: Sync current sprint issues to GitHub Issues. Creates GitHub issues for new sprint tasks, closes issues for completed tasks, and comments on blocked tasks. Uses gh CLI. Optional — enable during /aam-setup for team projects with a GitHub remote.
user-invocable: true

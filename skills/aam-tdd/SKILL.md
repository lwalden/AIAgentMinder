---
name: aam-tdd
description: Guided TDD workflow — red-green-refactor with structured phases for planning, tracer bullet, incremental loop, and post-green refactoring. Language-agnostic. Complements code-quality.md's TDD one-liner with a full methodology when you need it.
argument-hint: "[optional: describe the feature or behavior to test-drive]"
user-invocable: true

---
name: aam-triage
description: Structured bug triage — reproduce, diagnose root cause, design a durable fix plan, and create a GitHub issue with root cause analysis. Produces fixes that survive codebase changes by targeting behaviors and contracts, not internal structure.
argument-hint: "[describe the bug, error, or unexpected behavior]"
user-invocable: true

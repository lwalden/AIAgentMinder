---
name: handoff
description: Session checkpoint — capture current state so work can be resumed cleanly. Updates DECISIONS.md, writes priorities to MEMORY.md, and prints a structured briefing. Run this before ending a session.
user-invocable: true

...
# /aiagentminder:scope-check - Active Scope Governance
...
> `/aiagentminder:scope-check` — Add dark mode toggle to the settings page

> `/aiagentminder:scope-check` — Refactor the auth middleware to support OAuth providers
